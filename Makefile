...
all: disksim rms hplcomb syssim yusim
...
yuclean:
	rm -f yusim.o yu_debug.o yu_prize.o yu_structure.o yu_syssim.o yu_ipc.o yu_cache.o yu_credit.o yu_statistics.o
...
DISKSIM_SRC = disksim.c disksim_intr.c disksim_pfsim.c \
	...
	raw_layout.c \
	yu_debug.c yu_prize.c yu_structure.c yu_syssim.c yu_ipc.c yu_cache.c yu_credit.c yu_statistics.c
...
yusim: yusim.o libdisksim.a yu_syssim.o
	$(CC) $(CFLAGS) -o $@ yusim.o disksim_interface.o $(LDFLAGS) -pthread
